...
(function () {
  ...
  function render(container, design, opts) {
    ...
    const refundHref = (() => { const m = /^\/f\/(\d+)\/([^/?#]+)/.exec(location.pathname); return m ? `/reembolsos?e=${m[1]}&f=${encodeURIComponent(m[2])}` : '/reembolsos'; })();
